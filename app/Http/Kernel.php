...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        // autres middlewares
        'utilisateur.validation' => \App\Http\Middleware\UtilisateurValidation::class,
        'check.admin' => \App\Http\Middleware\CheckAdmin::class,
        'validate.maladie.chronique' => \App\Http\Middleware\ValidateMaladieChronique::class,
        'logout' => \App\Http\Middleware\LogoutMiddleware::class,
        'identify.comment.author' => \App\Http\Middleware\IdentifyCommentAuthor::class,
